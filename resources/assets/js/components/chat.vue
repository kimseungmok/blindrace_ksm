...
<div>
    ...
    <div class='chatbox' >
        <div class='chatbox__user-list'>
            <h1>Rooms</h1>
            <div v-bind:class='room == "General" ? "chatbox__user--active" : "chatbox__user--busy"' @click="joinRoom('General')">
                <p>General </p>
            </div>
            <div v-bind:class='room == "Mens" ? "chatbox__user--active" : "chatbox__user--busy"' @click="joinRoom('Mens')">
                <p>Mens</p>
            </div>
            <div v-bind:class='room == "Cars" ? "chatbox__user--active" : "chatbox__user--busy"' @click="joinRoom('Cars')">
                <p>Cars</p>
            </div>
            <div v-bind:class='room == "Bikes" ? "chatbox__user--active" : "chatbox__user--busy"' @click="joinRoom('Bikes')">
                <p>Bikes</p>
            </div>
            <div v-bind:class='room == "Cook" ? "chatbox__user--active" : "chatbox__user--busy"' @click="joinRoom('Cook')">
                <p>Cook</p>
            </div>
        </div>
